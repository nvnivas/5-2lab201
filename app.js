...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var sumVal = a + b + c;
  var multVal = a * b * c;
  var sumStr = a + ' and ' + b + ' and ' + c + ' sum to ' + sumVal + '.';
  var multiStr = 'The product of '+ a + ' and ' + b + ' and ' + c + ' is ' + multVal + '.';

  return [sumVal, multVal, sumStr, multiStr];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var returnArray = [sumTotal, sumTotalStr];
